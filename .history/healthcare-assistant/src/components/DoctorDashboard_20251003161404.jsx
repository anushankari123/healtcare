...
// Updated fetchPatientDetails with better debugging
const fetchPatientDetails = async (patientId) => {
  ...
  try {
    ...
    if (patientData && !error) {
      // Check what data structure we actually have
      const medicalRecords = patientData.medical_records || 
                           patientData.records || 
                           patientData.medical_records_list || 
                           [];
      
      const predictions = patientData.predictions || 
                         patientData.ai_predictions || 
                         patientData.analysis_history || 
                         [];
