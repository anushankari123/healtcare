  ...
  <div className="w-full min-h-[70vh] flex flex-col">
    <div className={`flex-1 flex flex-col h-full ${
      ...
      <div className="flex-1 flex flex-col overflow-hidden w-full">
        ...
        {/* History Tab */}
        {activeTab === 'history' && (
  <div className={`min-h-screen w-full ${darkMode ? 'bg-slate-900' : 'bg-gray-50'} p-6 lg:p-8`}>
    <div className={`rounded-xl shadow-lg border ${darkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'} min-h-[calc(100vh-4rem)]`}>
      <div className="p-6">
        <h2 className="text-2xl font-bold mb-6 flex items-center">
        ...
        {loading.history ? (
          ...
          <div className={`flex flex-col items-center justify-center min-h-[400px] ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
